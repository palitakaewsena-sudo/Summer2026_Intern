...
├── reconfigurable-reflectarray-20gh/      <-- Project 2: 20 GHz 1-bit reflectarray project
│   ├── README.md                          <-- Project-specific technical guide
...
├── CST_I_shape_26GHz/                     <-- Project 3: 26 GHz active I-shape RIS project
│   ├── README.md                          <-- Project-specific technical guide
...
└── metasurface-pindiode-lumped-modeling/  <-- Project 4: PIN diode lumped equivalent modeling
    ├── README.md                          <-- Project-specific technical guide
...
### 2. 20 GHz 1-Bit Reconfigurable Reflectarray (`reconfigurable-reflectarray-20gh`)
...
### 3. 26 GHz Active I-Shape RIS (`CST_I_shape_26GHz`)
...
### 4. PIN Diode Lumped Equivalent Modeling (`metasurface-pindiode-lumped-modeling`)
